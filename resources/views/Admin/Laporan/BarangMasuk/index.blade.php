            ...
            <div class="card-body">
                <div class="row mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <button class="btn btn-secondary-light" onclick="excel()"><i class="fa fa-file-excel-o"></i> Excel</button>
                    </div>
                </div>
...
<script>
    ...
    function getData() {
        ...
        table = $('#table-1').DataTable({
            ...
            "ajax": {
                ...
                "data" : function(da) {
                    da.tglawal = $('input[name="tglawal"]').val();
                    da.tglakhir = $('input[name="tglakhir"]').val();
                }
            },
            //     "data": function(d) {
    ...
    function excel() {
        ...
        if (tglawal != '' & tglakhir != ''){
         window.open(
            "{{route('lap-bm.excel')}}?tglawal=" + tglawal + "&tglakhir=" + tglakhir,
            '_blank'
        );
    } else {
            swal({
