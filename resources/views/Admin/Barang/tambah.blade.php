            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-7">
                        ...
                        <div class="form-group">
                            <label for="totalstok" class="form-label">Stok Awal</label>
                            <input type="text" name="totalstok" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="form-group">
...
<script>
    function checkForm() {
        ...
        const totalstok = $("input[name='totalstok']").val();
        setLoading(true);
        resetValid();
        if (kode == "") {
            ...
            setLoading(false);
            return false;
        // +totalstok = konversi string langsung numerik
            // } else if (+totalstok > harga ) {
        //     validasi('stok > harga!', 'warning');
        //     $("input[name='totalstok']").addClass('is-invalid');
        //     setLoading(false);
        }else{
            submitForm();
        }
    ...
    function resetValid() {
        ...
        $("input[name='totalstok']").removeClass('is-invalid');
    };
    function reset() {
        resetValid();
        $("input[name='kode']").val('');
