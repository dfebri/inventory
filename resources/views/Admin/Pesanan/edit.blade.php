            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="namaU" class="form-label">Nama</label>
                            <input type="text" name="namaU" class="form-control" placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="divisiU" class="form-label">Divisi<span class="text-danger">*</span></label>
                            <input type="text" name="divisiU" class="form-control" placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="barangU" class="form-label">Barang Baru</label>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="jumlahU" class="form-label">Jumlah Request<span class="text-danger">*</span></label>
...
@section('formEditJS')
    ...
    function checkFormU(){
        ...
        //     $("input[name='barangU']").addClass('is-invalid');
        //     setLoadingU(false);
        //     return(false);
        }else{
            submitFormU();
