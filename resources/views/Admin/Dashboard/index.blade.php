            ...
            <div class="card-body">
                <div class="d-flex">
                    <div class="text-white">
                        ...
                        <a style="color:azure" href="https://atkmgm.com/admin/barang">More Info <i class="bi bi-arrow-right"></i></a>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex">
                    <div class="text-white">
                        ...
                        <a style = "color:azure" href="https://atkmgm.com/admin/order">More Info <i class="bi bi-arrow-right"></i></a>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex">
                    <div class="text-white">
                        ...
                        <a style = "color: azure" href="https://atkmgm.com/admin/barang-masuk">More Info <i class="bi bi-arrow-right"></i></a>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex">
                    <div class="text-white">
                        ...
                        <a style = "color:azure" href="https://atkmgm.com/admin/barang-keluar">More Info <i class="bi bi-arrow-right"></i></a>
