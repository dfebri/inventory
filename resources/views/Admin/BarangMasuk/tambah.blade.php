            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="bmharga" class="form-label">Harga </label>
                            <input type="text" name="bmharga" class="form-control" placeholder="Rp.">
                        </div>
                        {{-- <div class="form-group">
...
<script>
    ...
    function submitForm() {
        ...
        const bmharga = $("input[name='bmharga']").val();
        // const customer = $("select[name='customer']").val();
        const jml = $("input[name='jml']").val();
    ...
    function resetValid() {
        ...
        $("input[name='bmharga']").removeClass('is-invalid');
