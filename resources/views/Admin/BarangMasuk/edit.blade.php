            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="bmhargaU" class="form-label">Harga </label>
                            <input type="text" name="bmhargaU" class="form-control" placeholder="Rp.">
                        </div>
                        {{-- <div class="form-group">
...
<script>
    ...
    function submitFormU() {
        ...
        const tglmasuk = $("input[name='tglmasukU']").val();
        const kdbarang = $("input[name='kdbarangU']").val();
        const bmharga = $("input[name='bmhargaU']").val();
        // const customer = $("select[name='customerU']").val();
        const jml = $("input[name='jmlU']").val();
    ...
    function resetValidU() {
        ...
        $("input[name='bmhargaU']").removeClass('is-invalid');
