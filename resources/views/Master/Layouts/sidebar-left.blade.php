 ...
 <div class="app-sidebar">
     <div class="side-header">
         <a class="header-brand1" href="{{url('/admin')}}">
             ...
             <img src="{{url('/assets/default/web/E-ATK.png')}}" height="40px" class="header-brand-img toggle-logo" alt="logo">
             ...
             <img src="{{url('/assets/default/web/E-ATK.png')}}" height="40px" class="header-brand-img light-logo" alt="logo">
