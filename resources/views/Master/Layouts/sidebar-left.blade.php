 ...
 <div class="app-sidebar">
     <div class="side-header">
         <a class="header-brand1" href="{{url('/admin')}}">
             ...
             <img src="{{url('/assets/default/web/MGMaritim.png')}}" height="40px" class="header-brand-img toggle-logo" alt="logo">
             ...
             <img src="{{url('/assets/default/web/MGMaritim.png')}}" height="40px" class="header-brand-img light-logo" alt="logo">
     ...
     <div class="main-sidemenu">
         ...
         <ul class="side-menu">
             ...
             <li class="slide">
                <a class ="side-menu__item" data-bs-effect="effect-super-scalde" data-bs-toggle="modal" href="#modalLogout"><i class="side-menu__icon fe fe-log-out"></i><span class= "side-menu__label">Log Out</span></a>
             </li>
         </ul>
