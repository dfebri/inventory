...
use Carbon\Carbon;
use App\Http\Requests\StoreBarangMasukModelRequest;
use App\Http\Requests\UpdateBarangMasukModelRequest;
    ...
    public function show(Request $request)
    {
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->rawColumns(['action', 'tgl', 'barang', 'currency'])->make(true);
        }
    }
