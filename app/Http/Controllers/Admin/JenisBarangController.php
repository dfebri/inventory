...
class JenisBarangController extends Controller
{
    ...
    {
        $data["title"] = "Jenis";
        $data["hakTambah"] = AksesModel::leftJoin('tbl_submenu', 'tbl_submenu.submenu_id', 
        '=', 'tbl_akses.submenu_id')->where(array('tbl_akses.role_id' => 
        Session::get('user')->role_id, 'tbl_submenu.submenu_judul' => 
        'Jenis', 'tbl_akses.akses_type' => 'create'))->count();
    ...
    public function proses_ubah(Request $request, JenisBarangModel $jenisbarang)
    {
        ...
        return response()->json(['success' => 'Berhasil diupdate yaaay']);
    }
