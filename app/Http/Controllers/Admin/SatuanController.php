...
class SatuanController extends Controller
{
    public function index()
    {
        ...
        ('tbl_submenu', 'tbl_submenu.submenu_id', '=', 'tbl_akses.submenu_id')
        ->where(array('tbl_akses.role_id' => Session::get('user')
        ->role_id, 'tbl_submenu.submenu_judul' => 'Satuan', 'tbl_akses.akses_type' => 'create'))->count();
